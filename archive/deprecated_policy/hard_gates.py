...
ARCHITECTURAL NOTE (December 2025):
This file contains HELPER FUNCTIONS for individual gate checks.
These should be called BY enforcement.py, not used directly.

CANONICAL ARCHITECTURE:
- enforcement.py is THE SINGLE enforcement gate for all MCP tools
- WorldAdapter is THE SINGLE source for path visibility
- hard_gates.py functions are implementation helpers, not public API

DO NOT:
- Call run_all_gates() directly (it's deprecated/dead code)
- Pass local_mods_folder directly to gates (use enforcement.py)
- Duplicate path-checking logic here (belongs in enforcement.py)

If you need to check permissions, use:
...
Each gate returns a GateResult: (allowed: bool, gate_name: str, reason: str)
...
# =============================================================================
# DEPRECATED: COMPOSITE GATE RUNNER
# =============================================================================
...
def run_all_gates(
    *,
    ...
    # Scope context - DEPRECATED: Use enforcement.py instead
    local_mod_roots: set[str] | None = None,  # DEPRECATED
    workshop_roots: set[str] | None = None,   # DEPRECATED
